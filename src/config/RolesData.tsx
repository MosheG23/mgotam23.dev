...
const fullStackTeamLeadScoutingReportData: ScoutingReportData = {
  ...
  highlights: [
    {
      ...
      text: "Architected 5+ platforms from zero to production",
    },
    {
    ...
    },
    {
      ...
      text: "Created modular GIS C2 system used by 3 projects",
    },
    {
      icon: <TrendingUp className="w-4 h-4" />,
      text: "Improved observability with ELK stack",
    },
  ],
  stats: [
      ...
      qualities: [
        {
          ...
          desc: "Deep expertise across full stack, sets high code standards",
        },
        {
          title: "Strategic Vision",
          desc: "Sees the big picture while managing tactical execution",
        },
        {
          title: "Team Multiplier",
          desc: "Elevates team performance through mentoring and support",
        },
        {
          title: "Clear Communication",
          desc: "Bridges technical and business stakeholders effectively",
        },
        {
          title: "Problem Solver",
          desc: "Quickly identifies and removes blockers for the team",
        },
        {
          title: "Adaptive Leadership",
          desc: "Adjusts style based on team needs and project phase",
        },
      ],
    },
  ],
  assessment: {
    ...
    strengths: [
      {
        ...
        detail: "Python, React, Next.js mastery",
      },
      {
        title: "Architecture thinking",
        detail: "Builds for scale and modularity",
      },
      {
        title: "Technology scouting",
        detail: "Adopts emerging tech strategically",
      },
      {
        title: "Team multiplier",
        detail: "Elevates cross-functional delivery",
      },
      {
        title: "Parallel execution",
        detail: "Manages 2-4 projects seamlessly",
      },
    ],
    playingStyle: {
      title: "Point Forward",
      description:
        "Combines individual scoring ability with team orchestration. Can take over games when needed but prefers to make everyone around them better. Creates opportunities for others while maintaining elite personal production.",
    },
    grades: [
    ...
    projection:
      "Ready for larger scope, bigger teams, strategic technical leadership. Look to make impact with the knowledge/experience gained from latest years. Positioned to drive organizational transformation through technical excellence and team leadership.",
    comparableTo:
      "Elite tech leads who transitioned to engineering management while maintaining technical depth. Similar trajectory to principal engineers who become VPs of Engineering at high-growth companies.",
  },
};
