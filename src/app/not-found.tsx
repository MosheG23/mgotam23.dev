    ...
    <div className="min-h-screen bg-[#111827] text-[#F9FAFB] font-sans flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="text-center relative z-10">
        ...
        <p className="text-lg text-gray-400 mb-8 max-w-sm mx-auto">
          Looks like you've taken a shot from way outside the court. The page
          you're looking for couldn't be found.
        </p>

        <a
          href="/"
          className="inline-flex items-center gap-2 bg-orange-500 text-gray-900 px-8 py-3 rounded-lg font-semibold hover:bg-orange-600 transition-all transform hover:scale-105"
        >
          <Home size={20} />
