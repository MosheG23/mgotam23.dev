      ...
      plays: [
        {
          ...
          setup: {
            ...
            content:
              "Internal teams struggling with language barriers in global work. Existing tools: slow, clunky, broke workflow. Accessibility gap.",
          },
          quarters: [
            {
          ...
          stats: [
            {
              ...
              value: "3-5 sec → <0.5 sec (90% faster)",
            },
            {
              label: "User adoption",
              value: "0 → 200+ internal users in 2 months",
            },
            {
              label: "Meeting efficiency",
              value: "30% time saved in multilingual calls",
            },
            {
              label: "Accessibility score",
              value: "Improved company-wide communication",
            },
          ],
        ...
        },
        {
          ...
          approach:
            "Doesn't chase shiny objects. Identifies real problems, then researches proven solutions. Prototypes fast, measures impact, then scales. Smart risk-taker.",
        },
      ],
    },
    {
      ...
      plays: [
        {
          ...
          setup: {
            title: "THE SITUATION",
            content:
              "Managing 2-4 full-stack projects simultaneously across cross-functional teams. Backend Python services, React frontends, Next.js apps - all moving at different speeds.",
          },
          strategies: [
            {
          ...
          leadershipStyle:
            "Leads from the front. Writes code alongside the team while maintaining strategic oversight. Removes blockers fast. Clear communicator who translates between technical and business.",
        },
      ],
    },
  ];
  ...
  const highlights = [
    {
      ...
      text: "Architected more than 5 platforms from zero to production",
    },
    {
      icon: <Rocket className="w-5 h-5" />,
      text: "Introduced new technologies that became company standards",
    },
    {
      icon: <Users className="w-5 h-5" />,
      text: "Led cross-functional teams across 2-4 concurrent projects",
    },
    {
      icon: <Zap className="w-5 h-5" />,
      text: "Built real-time LLM translation tool (company first)",
    },
    {
      icon: <Target className="w-5 h-5" />,
      text: "Created modular GIS C2 system used by 3 projects in the last year",
    },
    {
      icon: <TrendingUp className="w-5 h-5" />,
      text: "Improved observability with ELK (hours → minutes debug time)",
    },
  ];
    ...
    <div className="bg-[#1F2937] min-h-screen p-4 md:p-8">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 backdrop-blur-sm rounded-xl border border-gray-700 p-6 md:p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {highlights.map((highlight, idx) => (
              <div
                key={idx}
                className="flex items-start gap-4 bg-gradient-to-br from-gray-800/70 to-gray-800/40 rounded-lg p-5 border border-gray-700 hover:border-orange-500/50 hover:translate-x-1 transition-all duration-300 group"
              >
        ...
        {filmRooms.map((room) => (
          <div
            key={room.id}
            className="bg-gradient-to-br from-gray-900/70 to-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 shadow-xl overflow-hidden relative group hover:border-orange-600/40 hover:shadow-2xl transition-all duration-300"
          >
            <BasketballTexture />
            ...
            >
              ...
              <div
                className={`transition-transform duration-300 ${expandedFilm === room.id ? "rotate-180" : ""}`}
              >
                      ...
                      <div>
                        ...
                        <div className="space-y-5">
                          {play.quarters.map((quarter: any, qIdx: number) => (
                            <div
                              key={qIdx}
                              className="bg-gradient-to-r from-gray-800/60 to-gray-800/30 rounded-xl p-5 border border-gray-700 hover:border-orange-500/30 transition-all duration-300"
                            >
                    ...
                    {play.technologies && (
                      <div className="space-y-5">
                        ...
                        {play.technologies.map((tech: any, tIdx: number) => (
                          <div
                            key={tIdx}
                            className="bg-gradient-to-br from-gray-800/70 to-gray-800/40 rounded-xl p-6 border border-gray-700 hover:border-blue-500/30 transition-all duration-300 hover:translate-x-1"
                          >
                            ...
                            <div className="space-y-3 text-sm">
                              <div className="flex gap-3">
                                <span className="text-gray-500 font-semibold min-w-28">
                                  Challenge:
                                </span>
                                <span className="text-gray-300 leading-relaxed">
                                  {tech.challenge}
                    ...
                    {play.strategies && (
                      <div className="space-y-5">
                        {play.strategies.map((strategy: any, sIdx: number) => (
                          <div
                            key={sIdx}
                            className="bg-gradient-to-br from-gray-800/70 to-gray-800/40 rounded-xl p-6 border border-gray-700 hover:border-green-500/30 transition-all duration-300"
                          >
                            <div className="font-bold text-orange-400 mb-4 text-lg">
                              {strategy.type}
                            </div>
                            <ul className="space-y-3">
                              {strategy.tactics.map(
                                (tactic: string, tIdx: number) => (
                                  <li
                                    key={tIdx}
                                    className="text-gray-300 text-sm flex items-start gap-3 leading-relaxed"
                                  >
                      ...
                      <div>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          {play.stats.map((stat: any, sIdx: number) => (
                            <div
                              key={sIdx}
                              className="bg-gradient-to-br from-gray-800 via-gray-800/80 to-gray-800/50 rounded-xl p-5 border border-gray-700 hover:border-orange-500/50 hover:scale-105 transition-all duration-300"
                            >
                              <div className="text-xs text-gray-500 mb-2 uppercase tracking-wide">
                                {stat.label}
                              </div>
                              <div className="text-base md:text-lg font-bold text-orange-400 leading-snug">
                                {stat.value}
                              </div>
                            </div>
                          ))}
                    ...
                    {play.innovationHighlights && (
                      <div>
                        ...
                        <div className="space-y-3">
                          {play.innovationHighlights.map(
                            (highlight: string, hIdx: number) => (
                              <div
                                key={hIdx}
                                className="flex items-start gap-4 text-gray-300 bg-gradient-to-r from-orange-900/20 to-orange-800/10 rounded-lg p-4 border border-orange-500/20 hover:border-orange-500/40 transition-colors"
                              >
        ...
        <div className="bg-gradient-to-br from-orange-900/40 to-orange-800/30 rounded-2xl border border-orange-500/40 p-8 md:p-10 shadow-2xl hover:shadow-orange-900/20 transition-all duration-300">
          ...
          <div className="space-y-8">
            <p className="text-gray-300 leading-relaxed text-lg md:text-xl italic border-l-4 border-orange-500 pl-6 py-2">
              "Elite two-way player. Builds complex systems from scratch while
              leading teams through delivery. Rare combination: deep technical
              skills + strategic vision + proactive innovation. Identifies
              problems before they're assigned and ships solutions."
            </p>

            <div>
              <h3 className="text-orange-400 font-bold mb-5 text-lg uppercase tracking-wide">
                STRENGTHS:
              </h3>
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-start gap-4 text-gray-300 bg-gray-900/40 rounded-lg p-4 hover:bg-gray-900/60 transition-colors"
                  >
                    <span className="text-orange-400 mt-1 font-bold text-lg">
                      •
                    </span>
            ...
            <div className="bg-gradient-to-br from-gray-900/60 to-gray-800/40 rounded-xl p-6 border border-orange-500/40 hover:border-orange-500/60 transition-colors duration-300">
              <h3 className="text-orange-400 font-bold mb-3 text-base uppercase tracking-wide">
                PLAYING STYLE:
              </h3>
              <p className="text-gray-300 leading-relaxed text-base">
                ...
                - Combines individual scoring ability with team orchestration.
                Can take over games when needed but prefers to make everyone
                around them better.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-900/50 to-blue-900/50 rounded-xl p-6 border border-purple-500/40 hover:border-purple-500/60 transition-colors duration-300">
              <h3 className="text-purple-400 font-bold mb-3 text-base uppercase tracking-wide">
                PROJECTION:
              </h3>
              <p className="text-gray-300 leading-relaxed text-base">
                Ready for larger scope, bigger teams, strategic technical
                leadership. Look to make impact with the knowledge/experience
                gained from latest years.
              </p>
            </div>
          </div>
        </div>
