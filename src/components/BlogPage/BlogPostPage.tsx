...
import type { Language, Post } from "@/lib/posts";
...
const PlaceholderImage: React.FC<PlaceholderImageProps> = ({
  ...
  return (
    ...
    >
      <h2 style={{ color: textColor, fontSize: mainTextFontSize }}>{text}</h2>
    </div>
  );
};
  ...
  return (
    <div className="bg-[#111827] text-white min-h-screen">
      <div className="max-w-4xl mx-auto py-12 px-6">
        <Link href="/" className="text-orange-500 hover:underline mb-8">
